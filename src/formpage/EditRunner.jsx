...
export default function EditRunner() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`http://localhost:3000/post/${id}`, formData);
            ...
            <div className="box-edit">
                ...
                <div className="box-2-edit mt-[5px]">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-edit row">
                            <div className="col">
                                <div className="topic-form-edit text-stone-950">ราคาชิ้นแรก</div>
                                <input
                                    name="price"
                            ...
                            <div className="col">
                                <div className="topic-form-edit text-stone-950">ชิ้นต่อไป +</div>
                                <input
                                    name="price_next"
